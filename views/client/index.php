                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12">
                        <div class="headline">
                            ...
                            <div class="owl-carousel owl-theme" id="headline">
                                <div class="item">
                                    <a href="#"><div class="badge">Top!</div> Nga để ngỏ khả năng 'kiểm soát toàn diện' các thành phố lớn Ukraine</a>
                                </div>
                                <div class="item">
                                    <a href="#">Philippines tố tàu do thám Trung Quốc xâm phạm chủ quyền</a>
                                </div>
                                <div class="item">
                                    <a href="#">'Cho con học lập trình sớm là quyết định đúng đắn của tôi'</a>
                                </div>
                            </div>
                        </div>
                        <div class="owl-carousel owl-theme slide" id="featured">
                            <div class="item">
                                <article class="featured">
                                    ...
                                    <figure>
                                        <img src="assets/client/images/news/img-change-1.jpg" alt="Sample Article">
                                    </figure>
                                    <div class="details">
                                        <div class="category"><a href="category.html">Du lịch</a></div>
                                        <h1><a href="single.html">Hà Nội mùa thay lá</a></h1>
                                        <div class="time">15 tháng 03, 2022</div>
                                    </div>
                                </article>
                            </div>
                            <div class="item">
                                <article class="featured">
                                    <div class="overlay"></div>
                                    <figure>
                                        <img src="assets/client/images/news/img14.jpg" alt="Sample Article">
                                    </figure>
                                    <div class="details">
                            ...
                            <div class="item">
                                <article class="featured">
                                    <div class="overlay"></div>
                                    <figure>
                                        <img src="assets/client/images/news/img13.jpg" alt="Sample Article">
                                    </figure>
                                    <div class="details">
                            ...
                            <div class="item">
                                <article class="featured">
                                    <div class="overlay"></div>
                                    <figure>
                                        <img src="assets/client/images/news/img05.jpg" alt="Sample Article">
                                    </figure>
                                    <div class="details">
                                ...
                                <div class="row">
                                    <article class="article col-md-12">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img10.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                                <div class="detail">
                                    ...
                                    <article class="article col-md-12">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img06.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                                <div class="detail">
                                ...
                                <div class="row">
                                    ...
                                    <article class="article col-md-12">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img07.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                                <div class="detail">
                        ...
                        <div class="banner">
                            <a href="#">
                                <img src="assets/client/images/ads.png" alt="Sample Article">
                            </a>
                        </div>
                                ...
                                <div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
                                    <article class="article-mini">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img09.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                    ...
                                    <article class="article-mini">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img01.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                                <h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
                                    ...
                                    <article class="article-mini">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img02.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                                    ...
                                    <article class="article-mini">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img08.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="padding">
                        ...
                        <div class="row">
                            <article class="col-md-12 article-list">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="assets/client/images/news/img11.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="details">
                                        <div class="detail">
                            ...
                            <article class="col-md-12 article-list">
                                <div class="inner">
                                    <figure>
                                        <a href="single.html">
                                            <img src="assets/client/images/news/img03.jpg" alt="Sample Article">
                                        </a>
                                    </figure>
                                    <div class="details">
                                        <div class="detail">
                            ...
                            <div class="aside-body">
                                <div class="featured-author">
                                    <div class="featured-author-inner">
                                        <div class="featured-author-cover" style="background-image: url('assets/client/images/news/img15.jpg');">
                                            <div class="badges">
                                                <div class="badge-item"><i class="ion-star"></i> Nổi bật</div>
                                            </div>
                                            <div class="featured-author-center">
                                                <figure class="featured-author-picture">
                                                    <img src="assets/client/images/nguyennhatanhpng-1555662150.png" alt="Sample Article">
                                                </figure>
                                                <div class="featured-author-info">
                                                    <h2 class="name" style="font-family: 'Lato';">Nguyễn Nhật Ánh</h2>
                                                    <div class="desc">@anhnn</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="featured-author-body">
                                            ...
                                            <div class="featured-author-quote">
                                                "Đối với một nhà báo, mỗi tình tiết nhỏ đều có một câu chuyện."
                                            </div>
                                            <div class="block">
                                                <h2 class="block-title" style="font-family: 'Arial';">Ảnh</h2>
                                                <div class="block-body">
                                                    <ul class="item-list-round" data-magnific="gallery">
                                                        <li><a href="assets/client/images/news/img06.jpg" style="background-image: url('assets/client/images/news/img06.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img07.jpg" style="background-image: url('assets/client/images/news/img07.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img08.jpg" style="background-image: url('assets/client/images/news/img08.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img09.jpg" style="background-image: url('assets/client/images/news/img09.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img10.jpg" style="background-image: url('assets/client/images/news/img10.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img11.jpg" style="background-image: url('assets/client/images/news/img11.jpg');"></a></li>
                                                        <li><a href="assets/client/images/news/img12.jpg" style="background-image: url('assets/client/images/news/img12.jpg');"><div class="more">+2</div></a></li>
                                                        <li class="hidden"><a href="assets/client/images/news/img13.jpg" style="background-image: url('assets/client/images/news/img13.jpg');"></a></li>
                                                        <li class="hidden"><a href="assets/client/images/news/img14.jpg" style="background-image: url('assets/client/images/news/img14.jpg');"></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="featured-author-footer">
                                                <a href="#">Các tác giả khác</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane active" id="recomended">
                                    <article class="article-fw">
                                        <div class="inner">
                                            <figure>
                                                <a href="single.html">
                                                    <img src="assets/client/images/news/img16.jpg" alt="Sample Article">
                                                </a>
                                            </figure>
                                            <div class="details">
                                                <div class="detail">
                                ...
                                <div class="tab-pane comments" id="comments">
                                    <div class="comment-list sm">
                                        <div class="item">
                                            <div class="user">
                                                <figure>
                                                    <img src="assets/client/images/img01.jpg" alt="User Picture">
                                                </figure>
                                                <div class="details">
                        ...
                        <aside id="sponsored">
                            ...
                            <div class="aside-body">
                                <ul class="sponsored">
                                    <li>
                                        <a href="#">
                                            <img src="assets/client/images/sponsored.png" alt="Sponsored">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                ...
                <div class="owl-carousel owl-theme carousel-1">
                    ...
                    <article class="article">
                        <div class="inner">
                            <figure>
                                <a href="single.html">
                                    <img src="assets/client/images/news/img15.jpg" alt="Sample Article">
                                </a>
                            </figure>
                            <div class="padding">
                                <div class="detail">
